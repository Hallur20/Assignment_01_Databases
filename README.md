...
<p>In this program you will be able to choose between options in the database such as:\n <b>see all data, insert new data, see data depending on the id-key</b></p>
